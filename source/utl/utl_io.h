...
#define utl_io_getd_fb_ap(x) utl_io_getd_fb_apr(&x) /**< Macro para facilitar @ref utl_io_getd_fb_apr */
    ...
    */
    ...
    void utl_io_put8_tb_apr(uint8_t value,
                            uint8_t** buf); /**< Coloca um uint8_t usando big endian e adiciona o ponteiro */
...
#define utl_io_put64_tb_ap(v, x) utl_io_put64_tb_apr(v, &x) /**< Macro para facilitar @ref utl_io_put64_tb_apr */
    ...
    void utl_io_putf_tl_apr(float value,
                            uint8_t** buf); /**< Coloca um float usando little endian e adiciona o ponteiro */
...
#define utl_io_putf_tb_ap(v, x) utl_io_putf_tb_apr(v, &x) /**< Macro para facilitar @ref utl_io_putf_tb_apr */
    ...
    void utl_io_putd_tb_apr(double value,
                            uint8_t** buf); /**< Coloca um double usando big endian e adiciona o ponteiro */
